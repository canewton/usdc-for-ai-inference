...
describe('GET /api/chat-generation', () => {
  ...
  beforeEach(() => {
    ...
    mockRequest = {
      json: jest.fn(),
      headers: new Headers(),
      url: 'http://localhost/api/chat-generation',
  ...
  it('should return 200 with chat generations for an authenticated user', async () => {
  ...
  it('should return 500 if there is an error fetching chat generations', async () => {
    const mockUser = { id: 'user-id' };
    mockRequest.headers.set('Authorization', 'Bearer valid-token');
